      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={profileForm.handleSubmit(onSubmitProfile)} className="space-y-4">
            <Input label="Display Name" {...profileForm.register("name")} error={profileForm.formState.errors.name?.message} />
            <Input label="Current Password" type="password" {...profileForm.register("currentPassword")} error={profileForm.formState.errors.currentPassword?.message} />
            <Input label="New Password (leave blank to keep current)" type="password" placeholder="••••••••" {...profileForm.register("newPassword")} error={profileForm.formState.errors.newPassword?.message} />
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Permanently delete your account. Your transactions will be kept in the household but your membership will be removed. This cannot be undone.
              </p>
              <Button
                variant="destructive"
                size="sm"
        ...
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-red-50 border border-red-200">
            ...
            <p className="text-xs text-red-600 mt-1">
              Your account will be deleted. Transactions you created will remain in the household.
              If you are the sole owner of a household with other members, you must transfer ownership first.
            </p>
          </div>
          ...
          <form onSubmit={deleteForm.handleSubmit(onSubmitDelete)} className="space-y-4">
            ...
            {deleteError && (
              <div className="p-3 rounded-lg bg-red-50 border border-red-200 text-sm text-red-600">{deleteError}</div>
            )}
